...
public class ChannelsPref extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.m_adapter = new PostAdapter(this, R.layout.channelpref_row,
				m_channels);
		setListAdapter(this.m_adapter);
		
		//dbHelper=new DatabaseHelper(this);
		//dbHelper.getEmployeeCount();
		...
		/* Settings the list checkbox event */
//		
//		CheckBox chkBx = (CheckBox) findViewById(R.id.chkBxPref);
...
//		});
		...
		new LoadMoreEntries().execute(null, null, null); // loads the entries for the first time		//showSettingsMessage();
	}
...
//			Toast.makeText(ChannelsPref.this, "Please select your favorite news channels from Preferences",
//					Toast.LENGTH_SHORT).show();
//		}
//		else{
//			Toast.makeText(ChannelsPref.this, "No more newsfor now!",
//					Toast.LENGTH_SHORT).show();
//		}
		m_adapter.notifyDataSetChanged();
		m_channels = null;
...
//			channelsList = getPosts(ChannelsPref.actionType);
...
//				o1.setRatingCount(Integer.parseInt(unitChannel[2].toString()));
//				m_channels.add(o1);
//			}
//		}
//		} catch (Exception e) {
...
//	}
	...
	private String[] getChannels(int itemCount) {
		// TODO Fetch items whose id is greater than itemCount
		String[] lstChannel;
		lstChannel = "GEO|http://geo.tv/data/rss/geo_pakistan.xml~AAJ TAK|http://geo.tv/data/rss/geo_pakistan.xml~SUPER SPORTS|http://geo.tv/data/rss/geo_pakistan.xml~CNN|http://geo.tv/data/rss/geo_pakistan.xml~BBC|http://geo.tv/data/rss/geo_pakistan.xml~FOX NEWS|http://geo.tv/data/rss/geo_pakistan.xml~DAWN NEWS|http://geo.tv/data/rss/geo_pakistan.xml~KTN|http://geo.tv/data/rss/geo_pakistan.xml~PTV|http://geo.tv/data/rss/geo_pakistan.xml~WWE|http://geo.tv/data/rss/geo_pakistan.xml~ETC|http://geo.tv/data/rss/geo_pakistan.xml~ETC|http://geo.tv/data/rss/geo_pakistan.xml~ETC|http://geo.tv/data/rss/geo_pakistan.xml~ETC|http://geo.tv/data/rss/geo_pakistan.xml~ETC|http://geo.tv/data/rss/geo_pakistan.xml~ETC|http://geo.tv/data/rss/geo_pakistan.xml~ETC|http://geo.tv/data/rss/geo_pakistan.xml"
				.split("~");
		return lstChannel;
	}
