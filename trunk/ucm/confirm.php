      ...
      <div class="sign_up_top"></div>
        <div class="sign_up">
            ...
            <div style="width:95%;margin:0 auto">   
             <table cellspacing="2" cellpadding="10" style="">
                <tr>
                    <td>
                        <table align="right" width="" border="0" cellspacing="0" cellpadding="0" height="300px">
                            <tr>
                                <td align="left" valign="top">
                                     <h3><?php echo $item['Confirm_title']; ?></h3>
                                    <br />
                                        <div class="registration-heading">Thanks for signing up on YouCureMe! We just sent you a <br />confirmation email to <strong><?php echo $email; ?></strong>.
                                        <br /><br />
                                        Please check your email and click on the link in the email to <br />complete your sign up. 
                                        <br /><br />
										If you do not find confirmation email in your inbox, then <br />please check your junk mailbox as well.
                                        </div>  
                                        <br /><br /> <br /><br />
                                        <div style="clear:both;"><br /><br /></div>
                                         <div class="login_button" style="float:right">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </div> <br /><br />  <br /><br />  <br /><br /> 
                                            
                                </td>
                            </tr>	
                            <tr><td> <br /><br /><p><p> <br /><br /></p></p></td></tr>			
                        </table>
                    </td>
                </tr>
                </table>
