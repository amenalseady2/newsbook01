                         ...
                         <table cellpadding="0" cellspacing="0" style="width:686px; border:0px;">
							...
							?>
                                <tr style="height:25px;">
                                   <td align="left" class="size11"><?php echo $row["name"];?></td>   									
                                    <td    class="size11">&nbsp;<?php echo $row["email"];?></td> 
									<td  class="size11">&nbsp;<?php echo $row['subject'];?></td>                                       
									<td class="size11">&nbsp;<?php echo $row['sugbug'];?></td>
                                    <td class="size11">&nbsp;<?php echo $row['message'];?></td>
                                    <td  class="size11" align="right">&nbsp;<a class='bluelink' href="javascript:ConfirmUpdate('<?php echo $row["id"] ?>');" ><?php echo $row['status']?></a></td>
