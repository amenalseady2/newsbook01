...
<div class="warpper">
 ...
 browsing or are a friend / family member, please participate by completing it with that person in mind. <br>Our researchers and community sincerely thank you for your contribution.
											<p>    
											<p>	
							...
							?>
                                        ...
                                        $query_check_if_user_has_given_answer = "
                                        SELECT * FROM tblusersurveyans
                                        WHERE questionid = ".$rowq["questionid"]."
                                        and userid = ".$userid;
                                        
                                        
										$check_sql=mysql_query($query_check_if_user_has_given_answer);
										$user_has_given_answer=mysql_num_rows($check_sql);
										if($user_has_given_answer>0)
											$answer_given = true;
										else 
											$answer_given = false;	
                                        ...
                                        if(!$answer_given){
                                        //no answer given so show the multiple questions
                                        
                                        	if(!$is_form_tag_present){
                                        		?>
                                        		<form action="submitsurvey.php" method="post" enctype="multipart/form-data" >
                                    			<input type="hidden" id="userid" name="userid" value="<?php echo $userid; ?>" />
                                        		<?php 
                                        		$is_form_tag_present=true;
                                        	}
                                        ...
                                        $query_answers="SELECT COUNT( * ) , questionid, qansid, userid
