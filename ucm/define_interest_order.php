...
$("#menu-pages").sortable({
	 ...
	 $.post("define_interest_order_ajax.php", { pages: pageOrder } );
	 $( "#button" ).click();
     }
  });
});
...
<div class="body">
	<h1 style="color: #0D4C94;">Interest Order</h1>
...
<div class="toggler">
	<div id="effect" class="ui-widget-content ui-corner-all">
		...
		<p>
			<strong style="color: #0D4C94;">Interest Order has been saved !</strong>
		</p>
	</div>
</div>
...
$query_to_order =  sprintf("select `diseaseid`, `strdisease`, `disease_status`, `Interestsuggestedby`, `order` from tbldisease order by `order`");
$result = mysql_query($query_to_order);
?>
