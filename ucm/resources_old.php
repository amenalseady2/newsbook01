							...
							// {							
								...
								// {	
									...
									// $message=$message."<div class='req-general'>";
										...
										// else
											// $message=$message."<div class='searchlist'><a class='reqlisttitle' href='viewprofile.php?userid=".$row["userid"]."'><img src='profilepics/empty_profile.jpg' style='background-color:#FFFFFF' width='63' height='59' border='0'></a></div>";
        	...
        	<div class="left_side">
            	<!--<div class="left_contant">
                    ...
                    <div class="profile_links">
                        ...
                        <div class="txt_links">
                        	<ul>
                            	<li><a href="members.php">Explore YouCureMe network</a></li>
                            </ul>
                            <ul>
                                <li>
