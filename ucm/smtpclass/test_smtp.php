 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$from="info@youcureme.com";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="sufian_engineer@hotmail.com";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
	...
	$smtp->localhost="youcureme.com";       /* Your computer address */
	...
	$smtp->user="info@youcureme.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="youcur3m3";                 /* Set to the authetication password */
	$smtp->workstation="";              /* Workstation name for NTLM authentication */
	$smtp->authentication_mechanism="SSL"; /* Specify a SASL authentication method like LOGIN, PLAIN, CRAM-MD5, NTLM, etc..
