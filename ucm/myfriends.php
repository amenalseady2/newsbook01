                        ...
                        <td style="width:686px;" align="left" valign="top">
							...
							{							
								...
								{	 
									...
									$overlay_profile_picture = ($profile_picture=="empty_profile.jpg") ? "tp-youcureme_35_201203231332476162.jpg" : $profile_picture;
									
											$message=$message."<div class='searchlist'><a class='group1' href='profilepics/".$overlay_profile_picture."'><img src='profilepics/".$profile_picture."' style='background-color:#FFFFFF' width='50' border='0'></a></div>";
										//else
											//$message=$message."<div class='searchlist'><a class='reqlisttitle' href='viewprofile.php?userid=".$row['friendwith']."'><img src='profilepics/empty_profile.jpg' style='background-color:#FFFFFF' width='50'  border='0'></a></div>";
