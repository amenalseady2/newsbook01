...
<div class="body_main">
    <div class="body_menu whitetitle">
        <a href="myprofile.php" class="whitetitle size12">Home</a>&nbsp;&nbsp;<span class="size9">>></span>&nbsp;&nbsp;<a href="photos.php" class="whitetitle size12">Photos</a>&nbsp;&nbsp;<span class="whitetitle size12">>></span>&nbsp;&nbsp;<span class="whitetitle size12">Create Album</span>
    </div>
    <div class="body">
        <div class="main_link">
            ...
            <div class="email_table">              
                ...
                <form action="albumadd.php" method="post" enctype="multipart/form-data" id="customForm" >
                    <tr>
                        <tr>
                        ...
                        <td colspan="4" style="width:561px;" align="left" class="size12">
                            <input type="text" name="albumname" id="albumname" style="width:120px; border:1px #bcbcbc solid; height:16px; padding-left:3px;"  />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="width:561px;" align="left" class="size12">
                            <textarea style="height: 120px; width: 248px; border:1px #bcbcbc solid;  padding-left:3px;" id="description" name="description" rows="3" cols="50"></textarea>
                    ...
                    <td colspan="4" style="width:561px;" align="left" >
                        <input id="submit-subscirbe" type="button" onclick="history.go(-1)" value="Cancel" />&nbsp;<input id="submit-subscirbe" type="submit" value="Create" />
                    </td>
                    </tr>
                    <tr>
                        <td style="width:36px; height:3px;" colspan="5" align="left" valign="top"></td>
