<?php	session_start();
	...
	if($friendshipstatus=="2")
	{
		...
		$EmailSubject = $name." accepted your Friend Request";
		// request for the person who has been added
		$query1="update tblfriends set friendshipstatus=".$friendshipstatus." where userid=".$userid." and friendwith=".$friendwith;						
		// request of the person who added a friend
		$query2="update tblfriends set friendshipstatus=".$friendshipstatus." where friendwith=".$userid." and userid=".$friendwith;
	...
	elseif($friendshipstatus=="3")
	{
		...
		$EmailSubject = $name." rejected your Friend Request";
		// request for the person who has been added
	...
	elseif($friendshipstatus=="un")
	{
		...
		$EmailSubject = $name."choose not to stay as your Friend";		
		$friendshipstatus=3;
	...
	{	
		...
		{
			echo "<script>location.href='viewprofile.php?userid=".$friendwith."' </script>";
