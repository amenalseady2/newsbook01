...
<div class="body_main">
    <div class="body_menu whitetitle">
        <a href="myprofile.php" class="whitetitle size12">Home</a>&nbsp;&nbsp;<span class="whitetitle size12">>></span>&nbsp;&nbsp;<a href="resources.php">Resources</a>&nbsp;&nbsp;<span class="size9">>></span>&nbsp;&nbsp;<span class="bluetitle size11">Add Resource</span>
    </div>
    <div class="body">
        <div class="main_link">
            ...
            <div class="email_table">              
                ...
                <form action="res_create.php" method="post" enctype="multipart/form-data" id="customForm" >
                    <tr>
                        <tr>
                        ...
                        <td colspan="4" style="width:561px;" align="left" class="size12">
                            <input type="text" name="subject" id="subject" style="width:120px; border:1px #bcbcbc solid; height:16px; padding-left:3px;"  />&nbsp;&nbsp;<span id="msgsubject"></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="width:561px;" align="left" class="size12">
                            <select name="resourcetypeid" id="resourcetypeid" style="width:120px; border:1px #bcbcbc solid; height:20px; padding-left:3px;" disabled="disabled">
                               <?php  
										if(isset($_GET["resourcetypeid"]))
										   $resourcetypeid = $_GET["resourcetypeid"];
										   
										$_SESSION["resourcetypeid"] = $resourcetypeid;
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="width:561px;" align="left" class="size12">
                            <select name="diseaseid" id="diseaseid" style="width:120px; border:1px #bcbcbc solid; height:22px; padding-left:3px;">
                                <?php    
										$q="select diseaseid,strdisease from tbldisease order by strdisease";	
										$r=mysql_query($q);
										if($r)
										{	
											$n=mysql_num_rows($r);
											...
											{			
												...
												while($rw=mysql_fetch_array($r))
												{
													if($rw["strdisease"] == $disease)
													{
														echo "<option value='".$rw["diseaseid"]."'";
														echo " selected='yes'>".$rw["strdisease"]."</option>";
														$count++;				
													}
													else{
														echo "<option value='".$rw["diseaseid"]."'";
                    ...
                    <tr>
						...
						<td colspan="4" style="width:561px;" align="left" class="size12">
                            <input type="text" name="link" id="link" style="width:248px; border:1px #bcbcbc solid; height:16px; padding-left:3px;" value="http://" />&nbsp;&nbsp;<span id="msgsubject"></span>
                        </td>  
 					</tr>
	                <tr>
                        <td style="width:36px; height:3px;" colspan="5" align="left" valign="top"></td>
                    ...
                    <tr>
                        <td style="width:125px;" align="left" class="bold size12">
                            <?php echo "Embed Video:";?>
                        </td>
						<td colspan="4" style="width:561px;" align="left" class="size12">
                            <input type="text" name="evlink" id="evlink" style="width:248px; border:1px #bcbcbc solid; height:40px; padding-left:3px;" /> 
                        </td>  
 					</tr>
					<?php }  ?>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="width:561px;" align="left" class="size12">
                            <textarea style="height: 120px; width: 248px; border:1px #bcbcbc solid;  padding-left:3px;" id="description" name="description" rows="3" cols="50"></textarea>&nbsp;&nbsp;<span id="msgdescription"></span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:36px; height:3px;" colspan="5" align="left" valign="top"></td>
